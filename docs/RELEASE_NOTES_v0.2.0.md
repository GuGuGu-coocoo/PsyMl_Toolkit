...
- 更新中英法操作说明和界面截图。源码包 `PsyML-Toolkit-v0.2.0.zip` 附两份中文离线 PDF，供开发者查阅；GitHub 自动生成的 Source code 不是独立应用。
...
- Updated Chinese, English and French instructions and screenshots. `PsyML-Toolkit-v0.2.0.zip` provides active sources and two Chinese offline PDFs for developers. GitHub's automatic Source code downloads are not standalone apps.
...
- Instructions et captures actualisées dans les trois langues. `PsyML-Toolkit-v0.2.0.zip` contient les sources actives et deux PDF chinois hors ligne pour les développeurs. Les archives Source code automatiques de GitHub ne sont pas des applications autonomes.
