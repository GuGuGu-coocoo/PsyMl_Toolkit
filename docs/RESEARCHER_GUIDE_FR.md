...
### Explication SHAP d'un échantillon (facultatif)
...
### Coefficients et intercepts ajustés
...
Un paquet autonome et une copie des sources peuvent contenir des correctifs différents. Les cinq points ci-dessous servent au re-test des sources.
