# -*- coding: utf-8 -*-
'''
@File    :   KNN_Regressor_sklearn.py
@Author  :   GuGuGu?coocoo! 
@Time    :   2023/08/20 14:54:41 UTC+08:00
...
def knn(file,test_size=0.3,n_neighbors=5,weights='distance',algorithm='kd_tree'):
    ...
    knn =KNeighborsRegressor(n_neighbors=n_neighbors,weights=weights,algorithm=algorithm,n_jobs=-1)
    knn.fit(train_X,train_y)

    # Calculate and save the scores of train and test in knn_result as a DataFrame
    ...
    knn_result = pd.DataFrame(result_dict)
