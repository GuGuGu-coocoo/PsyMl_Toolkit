...
def save_rnn(path, vocab_path, batch_size=32, test_size=0.2, hidden_size=100, L1=40, L2=30, num_epochs=20, lr=0.001, plt_status=False):
    ...
    file_path = os.path.join(target_directory, '{}-{}-{}-{}-{}-{}-{}-{}_result.xlsx'.format(file_name,batch_size,test_size,hidden_size,L1,L2,num_epochs,lr))
    rnn_writer = pd.ExcelWriter(file_path,engine='xlsxwriter')                        
    rnn_sheet_name = 'rnn'
